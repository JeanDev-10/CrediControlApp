                ...
                <form method="POST" action="{{ route('debts.update', $debt) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="description" name="description" type="text" class="w-full mt-1"
                            value="{{ old('description', $debt->description) }}" required />
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="quantity" name="quantity" type="number" step="0.01" class="w-full mt-1"
                            value="{{ old('quantity', $debt->quantity) }}" required />
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="date_start" name="date_start" type="date" class="w-full mt-1"
                            value="{{ old('date_start', $debt->date_start->format('Y-m-d')) }}" required />
                    ...
                    <div class="mb-4">
                        ...
                        <select id="contact_id" name="contact_id"
                            ...
                            @foreach($contacts as $contact)
                                <option value="{{ $contact->id }}" @selected(old('contact_id', $debt->contact_id) == $contact->id)>
