                ...
                <form method="GET" action="{{ route('debts.index') }}"
                    ...
                    <div class="w-full sm:w-auto">
                        ...
                        <select name="status" :value="request('status')"
                            class="rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 w-full sm:w-auto">
                    ...
                    <div class="grid grid-cols-2 gap-2 sm:gap-4 sm:ml-5 sm:mt-2">
                        <a href="{{ route('debts.export', request()->only(['description', 'contact_name','date_start','status'])) }}" target="_blank"
                            ...
                            Exportar PDF</a>
                        <x-link-button href="{{ route('debts.create') }}" variant="tertiary">
                            Nueva Deuda
                        </x-link-button>
                    </div>
                </form>
                        ...
                        <tbody class="border-b border-gray-200 dark:border-gray-700 text-black dark:text-gray-100">
                            @forelse($debts as $debt)
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-center">${{ number_format($debt->quantity, 2, '.', ',') }}
                                    </td>
