            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                <form method="POST" action="{{ route('users.update', $user) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="lastname" name="lastname" type="text" class="mt-1 block w-full" required :value="old('lastname', $user->lastname)" />
                    ...
                    <div class="flex justify-end">
                        ...
                        <x-terciary-button type="submit">Actualizar</x-terciary-button>
                    </div>
                </form>
            </div>
        </div>
